...
async def ferramentas(c: Client, m: Union[Message, CallbackQuery]):
    ...
    kb = InlineKeyboardMarkup(
        inline_keyboard=[
            [
                InlineKeyboardButton(text="🔸 Voltar", callback_data="shop"),
            ],
        ]
    )
...
<code>/chk</code> - Teste suas ccs, será descontado R$ 2,00 por cada live aprovada

<code>/separador</code> - separar ccs em seu formatado correto para venda ou datebases.
"""
