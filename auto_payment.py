        ...
        if rt == "PAGO":
           ## rt = "PAGO"
            ...
            await send.edit_text(
                f"<b>✅ Pagamento recebido.</b>\n\n<i>O valor de R${value} foi creditado em sua conta.</i>",
                reply_markup=kb,
            )
            ...
            await c.send_message(
                ADMIN_CHAT,
                f"<a href='https://t.me/elliotccs'>&#8204</a>💸 {mention} Adicionou <b>R${value}</b> de saldo\n\n<a href='https://t.me/elliotccs'>SUPORTE</a>",
            )
            mention = user.first_name
            await c.send_message(
                GRUPO_PUB,
                f"<a href='https://t.me/elliotccs'>&#8204</a>💸 {mention} Adicionou <b>R${value}</b> de saldo no bot\n\n<a href='https://t.me/elliotccs'>Suporte</a>",
            )
...
async def auto_pay(c: Client, m: Union[CallbackQuery, Message]):
    ...
    kb = InlineKeyboardMarkup(
        inline_keyboard=[
            [
                InlineKeyboardButton(
                    text="✔️ 00:00:60 !Aguarde!", callback_data="add_saldo_auto"
                )
            ]
        ]
    )
...
Se não conseguir fazer pix automático, chame o @elliotccs
"""
